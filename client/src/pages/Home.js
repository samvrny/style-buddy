...
const Home = () => {
    ...
    const [isSavedPalette, setIsSavedPalette] = useState(false)
    ...
    useEffect(() => {
        ...
        //let result = paletteIds.includes(randomizedPalette.id)
        //console.log(result)
    })
    // const getPaletteIds = () => {
    //     // setPaletteIds([])
    ...
    //     //     paletteIds.push(palette.id)
    //     // })
    //     const result = paletteIds.includes(randomizedPalette.id)
    //     setIsSavedPalette(result)
    //     console.log(result)
    //     console.log(randomizedPalette.id)
    //     console.log(paletteIds)
    // }
